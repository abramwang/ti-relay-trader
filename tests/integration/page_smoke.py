...
def build_checks(sdk_version: str) -> list[Check]:
    return [
        ...
        Check("docs-readme", "/docs/readme", "text", ("线程恢复卡片", "当前工作", "当前阻塞")),
        Check(
            "docs-readme-history",
            "/docs/readme-history-20260826",
            "text",
        ...
        Check("job-status", "/jobs", "text", ("后台任务状态", "job-status.js", "账户级人工复核")),
        Check("operations-status", "/operations", "text", ("网关与 Redis Stream", "operations-status.js", "Dead Letter Queue")),
        Check("portal-ui-css", "/assets/portal-ui.css", "text", (".global-header", ".developer-layout")),
        Check("api-console-css", "/assets/api-console.css", "text", (".api-console-v2", ".assertion-panel", ".collection-toolbar")),
        Check("api-console-js", "/assets/api-console.js", "text", ("api-console.catalog.json", "relay.api_console_collection.v1", "runAssertions", "fetch")),
        ...
        Check("job-status-js", "/assets/job-status.js", "text", ("loadJobs", "/v1/jobs/runs", "/v1/reconciliations/review-report")),
