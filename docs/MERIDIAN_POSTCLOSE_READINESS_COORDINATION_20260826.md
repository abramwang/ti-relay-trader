...
> `2026-09-22` 调度修订：Meridian 新链路在 16:30 日线父任务后增加 16:40/16:50 本地校准和质量复验，状态机截止改为 17:05。Relay 当前改为 17:10 首查、每 10 分钟重试至 19:10；下文 16:40/18:50 内容保留为 8 月首次联调的历史记录。
