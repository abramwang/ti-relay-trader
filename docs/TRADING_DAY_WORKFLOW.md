...
| 权威行情复算 | `performance_canonical` | 16:40-18:50 每 10 分钟检查 | Meridian 16:30 启动、16:45 SLA；三类未复权日线水位到达当日后重算 NAV，保留前后版本并审计差异 |
