...
- [x] 按可信锚点和数据质量开放首批绩效发布：首批账户先完成 v2.4 连续发布；券商资金与资产基数审计后，`307000051387/1388` 的 `2026-08-06..26` 共 30 个账户日已升级为 `performance_economic_nav.v2.6 provisional` 且 0 blocked；空账户 `307000051389` 保持 not_applicable。
