...
- `314000046830`：17 条人工资产/盈利金标继续独立版本化保存。交割单已证实 30 个 OC 交易日的订单/成交基线并补齐历史实际费用；绩效起点改为 `2026-07-22` 证券空仓日。7 月 22、23、28、29、30 日五个可计算金标全部在 0.01 元门禁内，22 日至 30 日的七个交易日成本/NAV 已连续重建，7 月 30 日累计净值 `0.972127585393`。7 月 31 日缺 OC close 快照保持 unavailable，不用交易流水补造资产快照。
