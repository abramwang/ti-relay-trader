...
func Catalog() CatalogDocument {
	return CatalogDocument{
		...
		HTTPRoutes: []HTTPRouteSpec{
			...
			{Method: "GET", Path: "/v1/meridian/metadata/instruments", Response: "Meridian metadata_instrument.v2 payload", Description: "proxy Meridian instrument metadata and authoritative price ticks without redefining fields"},
			{Method: "GET", Path: "/v1/meridian/metadata/status", Response: "Meridian metadata_status.v2 payload", Description: "proxy Meridian instrument and price tick quality status"},
