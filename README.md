...
1. 接入 Meridian `bars`，补全账户绩效序列、回撤和研究侧导出视图。
2. 增加 9092 页面冒烟测试脚本。
3. 增加 `/trade` 批量下单测试视图。
4. 设计模拟柜台账表 schema。
