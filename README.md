...
1. 继续与用户确认绩效正式净值、日内资产桥、逆回购、费用和外部现金流口径；ETF 申赎 T0 及股票/ETF 截面公司行为口径已经确认，全部讨论完成前不修改计算公式。
