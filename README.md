...
| 最近确认 | `2026-09-21 13:32 Asia/Shanghai` 盘前故障已从 PostgreSQL raw archive 部分恢复：四户 270 条 09:01 日初持仓落盘，债享5号完整日初资产恢复；其余三户缺盘前资金证据，保留前收盘回退和显式阻断。盘前任务已增加 `BROKER_NOT_READY` 有限重试 |
| 更新时间 | `2026-09-21` |
