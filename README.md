...
1. 推进 `post_close_settlement` 从报告摘要升级为实际写入日终 `asset_snapshots`、`position_snapshots` 和对账批次。
2. 增加 9092 页面冒烟测试脚本。
3. 设计模拟柜台账表 schema。
