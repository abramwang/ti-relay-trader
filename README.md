...
1. 继续与用户确认股票/ETF 截面、绩效正式净值、日内资产桥、逆回购、费用和外部现金流口径；ETF 申赎 T0 的 IOPV + 15bp 估算口径已经确认，全部讨论完成前不修改计算公式。
