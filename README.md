...
| 最近确认 | `2026-08-27` 两户开户以来券商资产基数完成审计，经济净值升级至 v2.6 并重建 30 个账户日 |
| 更新时间 | `2026-08-27` |
...
- 两户 `2026-08-06..2026-08-26` 共 30 个账户日已按 `performance_economic_nav.v2.6` 顺序重建，0 blocked。结果仍为 provisional，因为 ETF 清算资产和部分费用使用明确标记的估算口径。
...
2. 使用已落库的完整券商资产基数逐日验收两户历史曲线，明确券商总资产、公募占款和 Relay 经济净值三层口径。
